jQuery(document).ready(function () {
    ...
    function loadPet() {
        petId = localStorage.getItem("current_pet_id");
        $.ajax({
            dataType: 'json',
            url: "http://api.petfinder.com/pet.get?format=json&key=150d5bff08a3c97e69c2417d726c084d&id=" + petId,
            data: "",
    ...
    /*function populatePledge() {
        ...
        $.ajax({
            dataType: 'jsonp',
            url: "http://5sqk10icy4.execute-api.us-west-2.amazonaws.com/dev/pets/" + petId,
            data: "",
            success: function (data) {
                console.log(data);
            },
